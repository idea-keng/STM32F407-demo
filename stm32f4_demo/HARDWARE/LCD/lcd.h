...
void LCD_Show_ch(u16 x,u16 y,u16 width,u16 height,u8 size,u8 num);          //显示一个汉字
void LCD_Show_chstr(u16 x,u16 y,u8 size,int *num,u8 len);                   //显示一串汉字
void LCD_Show_bmp(u16 x,u16 y,u16 width,u16 height,u8 *bmp);                //显示一幅bmp图像
void LCD_Showfloat(u16 x,u16 y,float num,u8 len_z,u8 len_x,u8 size,u8 mode);//显示浮点数
